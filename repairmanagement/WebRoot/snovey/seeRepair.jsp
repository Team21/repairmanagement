	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
			...
			<div class="sidebar-menu-inner">	
				...
				<ul id="main-menu" class="main-menu">
					...
					<li>
						...
						<ul>
							<li>
								<a href="/RepairManagement/servlet/SeeReportServlet">
									<span class="title">监控报修</span>
								</a>
							</li>
							<li>
								<a href="/RepairManagement/servlet/SeeRepairServlet">
									<span class="title">监控维修</span>
								</a>
							</li>
								<li>
								<a href="/RepairManagement/servlet/SeeSattleServlet">
	  ...
	  <div class="main-content">
			...
			<div class="page-title">
				<!--这个是这个页面的hint -->
			  <div class="title-env">
					<h1 class="title">报修信息查询</h1>
					<p class="description">在这里，您可以看到报修的历史记录</p>
				</div>
					<!-- 这个是显示该页面的路径和依赖-->
			  <div class="breadcrumb-env">
								...
								<ol class="breadcrumb bc-1">
									<li>
							<a href="/RepairManagement/Findex.jsp"><i class="fa-home"></i>主页</a>
						</li>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">维修任务分配</h3>
						...
						<tbody>
							<c:forEach items="${data}" var="u">
								<tr>
									...
									<td>${u.repairArrangeTime }</td>
									<td>${u.repairRepairTime }</td>
									<td>
										<c:choose>
											<c:when test="${u.repairDelayDegree==1 }">一般</c:when>
											<c:when test="${u.repairDelayDegree==2 }">比较严重</c:when>
											<c:when test="${u.repairDelayDegree==3 }">严重</c:when>
										</c:choose>
									</td>		
								</tr>
							</c:forEach>
