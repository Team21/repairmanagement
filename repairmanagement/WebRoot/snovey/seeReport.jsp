			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<table id="example-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							<c:forEach items="${reportInfo}" var="s">
								<tr>
									<td>${s.reportNo }</td>
    								<td>${s.reportDevice }</td>
    								<td>${s.reportTime }</td>
    								<td>${s.reportPrice }</td>
    								<td>
    									<c:choose>
    										<c:when test="${s.reportState == '1'}">进行中</c:when>
    										<c:when test="${s.reportState == '2'}">结束</c:when>
    										<c:when test="${s.reportState == '3'}">撤销</c:when>
    									</c:choose>
    								</td>
							</tr>
							</c:forEach>
