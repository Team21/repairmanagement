	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	  ...
	  <div class="main-content">
			...
			<div class="page-title">
				<!--这个是这个页面的hint -->
			  <div class="title-env">
					<h1 class="title">准备结算</h1>
					<p class="description">在这里，你可以看到所有待结算的订单</p>
				</div>
					<!-- 这个是显示该页面的路径和依赖-->
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><strong>待结算的维修信息</strong></h3>
					<br/>
					<a href="/RepairManagement/servlet/FinishedQueryServlet"><button class="btn btn-turquoise">已完成维修记录</button></a>
					<a href="/RepairManagement/servlet/NoFinishedQueryServlet"><button class="btn btn-turquoise">所有维修记录</button></a>
					...
					<table class="table table-bordered table-striped" id="example-2">
						...
						<tbody class="middle-align">
							...
							<tr>
								...
								<td align="center">${u.repairNo }</td>
								<td align="center">${u.changedRepairPerson }</td>
								<td align="center">
									<c:choose>
										<c:when test="${u.repairState == '1'}">未分配</c:when>
										<c:when test="${u.repairState == '2'}">已分配</c:when>
										<c:when test="${u.repairState == '3'}">已维修</c:when>
										<c:when test="${u.repairState == '4'}">撤销</c:when>
									</c:choose>
								</td>
								<td align="center">
									<a href="/RepairManagement/servlet/PrintSattleList?repairno=${u.repairNo}" class="btn btn-secondary btn-sm btn-icon icon-left">
										结算
									</a>
								</td>
							</tr>
