	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	  ...
	  <div class="main-content">
			...
			<div class="page-title">
				<!--这个是这个页面的hint -->
			  <div class="title-env">
					<h1 class="title">维修任务管理模块</h1>
					<p class="description">您可以在这里分配、查询和管理维修单信息</p>
				</div>
			...
			<div class="panel panel-default">
                ...
                <form action="/RepairManagement/page/ArrangeCompleteServlet" method="GET">
					<table id="example-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<tr>
								<td width="40%">客户编号</td>
								<td>&nbsp;&nbsp;${data2.reportCustomerId }</td>
							</tr>
							<tr>
								<td width="40%">预估价格</td>
								<td>&nbsp;&nbsp;${data2.reportPrice }</td>
							</tr>
							<tr>
								<td width="40%">预估完成时间</td>
								<td>&nbsp;&nbsp;${data2.reportFinish }</td>
							</tr>
							<tr>
								<td width="40%">指定维修人员</td>
								<td>
									<select name="repair_arrange" class="form-control col-md-7 col-xs-12">
										<c:forEach items="${data3}" var="u">
											<option value=${u.employeeNo }>${u.employeeName }</option>									
										</c:forEach>
									</select>
								</td>
							</tr>
