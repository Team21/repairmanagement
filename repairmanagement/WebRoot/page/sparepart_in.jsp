	  ...
	  <div class="main-content">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal"  action="/RepairManagement/page/SparepartInServlet" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input name="sparepart_increase" type="text" class="form-control" id="field-1" placeholder="入库备件的数量">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">入库日期：</label>
