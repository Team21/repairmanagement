	  ...
	  <div class="main-content">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">维修备件流水记录</h3>
				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal"  action="/RepairManagement/page/EngineerSparepartServlet" method="post">
								
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">备件ID：</label>
									
									<div class="col-sm-10">
										<input name="repair_partflow_sparepart" type="text" class="form-control" id="field-1" placeholder="输入使用的备件的ID">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input name="repair_partflow_count" type="text" class="form-control"  placeholder="所用备件的数量">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1" >维修单ID：</label>
									
									<div class="col-sm-10">
										<input name="repair_partflow_repair" type="text" class="form-control"  placeholder="本次流水的相关维修单ID">
									</div>
								</div>
