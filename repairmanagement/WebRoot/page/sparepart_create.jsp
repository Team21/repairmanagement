	  ...
	  <div class="main-content">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal"  action="/RepairManagement/SparepartRegisterServlet" method="post">
								
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">备件名称</label>
									
									<div class="col-sm-10">
										<input  name="sparepart_name" type="text" class="form-control" id="field-1" placeholder="请在这里键入备件的名称">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1" >备件型号</label>
									
									<div class="col-sm-10">
										<input name="sparepart_type" type="text" class="form-control" id="field-1" placeholder="请在这里键入备件的型号">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">备件单价</label>
									
									<div class="col-sm-10">
										<input  name="sparepart_price" type="text" class="form-control" id="field-1" placeholder="请在这里键入单个备件的售价">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">警戒数量</label>
									
									<div class="col-sm-10">
										<input  name="sparepart_warn" type="text" class="form-control" id="field-1" placeholder="请在这里键入备件的警戒数量（这会影响备件的状态）">
									</div>
								</div>
