						...
						<tbody>
							<c:forEach items="${data}" var="u">
								<tr>
									...
									<td>未分配</td>							
									<td align="center">
										<a href="/RepairManagement/page/FaultRepairArrangeServlet?repair_no=${u.repairNo}&type=1"><button type="button" class="btn btn-turquoise btn-single" >分配</button></a>&nbsp;&nbsp;&nbsp;
										<a href="/RepairManagement/page/FaultRepairArrangeServlet?repair_no=${u.repairNo}&type=2"><button type="button" class="btn btn-red btn-single" >挂起</button></a>	
									</td>
								</tr>
							</c:forEach>
						</tbody>
