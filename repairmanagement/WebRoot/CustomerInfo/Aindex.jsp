			...
			<div class="sidebar-menu-inner">	
				...
				<ul id="main-menu" class="main-menu">
					...
					<li>
						...
						<ul>
							<li>
								<a href="CustomerInfo/form-findqi.jsp">
									<span class="title">客户查询与报修</span>
								</a>
							</li>
							<li>
								<a href="CustomerInfo/form-nativeqi.jsp">
	  ...
	  <div class="main-content">
			...
			<div class="page-title">
			  ...
			  <div class="breadcrumb-env">
									...
									<li>
							<a href="/RepairManagement/CustomerInfo/Aindex.jsp"><i class="fa-home"></i>主页</a>
						</li>
									...
									<div class="row">
										<div class="col-sm-6">
											...
											<blockquote>
											    ...
											    感谢您使用本系统进行办公，请您根据自己的职位选择使用角色功能，祝您工作顺利、生活愉快！. </p>
											</blockquote>
										...
										<div class="col-sm-6">
											...
											<blockquote>
											    ...
											    Thank you for using this system , please choose role function according to you own position , wish your work going well 、 working smoothly！ </p>
											</blockquote>
