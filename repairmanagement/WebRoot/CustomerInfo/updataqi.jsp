				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal" action="/RepairManagement/servlet/ZhenUpdata" method="post">
								
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1"><font color="#FF0000">*</font>姓名</label>
									
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-1" name="customerName" value="${data.customerName}" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-2" name="customerId" value="${data.customerId}">
									</div>
								</div>
							 ...
							 <div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control"  name="customerType"  value="${type}">
											<option>请选择</option>
											<option>家庭用户</option>
											<option>单位用户</option>
											<option>代理商</option>
							  ...
							  <div class="form-group">
							    <label class="col-sm-2 control-label" for="field-3">公司</label>
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-3"  name="customerOffice"  value="${data.customerOffice}">
							    ...
							    <label class="col-sm-2 control-label" for="field-3">固定电话号</label>
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-3" name="customerTel" value="${data.customerTel}">
							    ...
							    <label class="col-sm-2 control-label" for="field-3"><font color="#FF0000">*</font>移动电话号</label>
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-3"  name="customerMobile"  value="${data.customerMobile}">
							    ...
							    <label class="col-sm-2 control-label" for="field-3"><font color="#FF0000">*</font>客户地址</label>
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-3"  name="customerAddress"  value="${data.customerAddress}">
							  ...
							  <div class="form-group-separator"></div>
							    ...
							    <label class="col-sm-2 control-label" for="field-3">邮编</label>
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-3"  name="customerMail"  value="${data.customerMail}">
							    ...
							    <label class="col-sm-2 control-label" for="field-3">电子邮件</label>
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-3"  name="customerEmail"  value="${data.customerEmail}">
