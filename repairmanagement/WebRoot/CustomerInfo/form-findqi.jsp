	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	  ...
	  <div class="main-content">
			...
			<div class="page-title">
				<!--这个是这个页面的hint -->
			  <div class="title-env">
					<h1 class="title">客户信息确认</h1>
					<p class="description">查询客户是否已经存在
				</div>
					<!-- 这个是显示该页面的路径和依赖-->
				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form   action="/RepairManagement/QueryServlet" role="form" class="form-inline" method="post">
								
								<div class="form-group">
									<input type="text" class="form-control" size="25" placeholder="身份证号" name="id" />
								</div>
							</form>
							<div class="form-group" align="right">
									<button  onclick="doQuery()" class="btn btn-secondary btn-single">查询</button>
