	  ...
	  <div class="main-content">
			...
			<div class="page-title">
			  ...
			  <div class="title-env">
					...
					<p class="description">提取记录中的客户基本信息</p>
				</div>
					<!-- 这个是显示该页面的路径和依赖-->
            ...
            <div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">
								...
								<table cellspacing="0" class="table table-small-font table-bordered table-striped">
									<thead>
										<tr>
											...
											<th data-priority="1">移动电话</th>
											<th data-priority="1">地址</th>
                       						<th data-priority="1">邮编</th>
                                            <th data-priority="1">电子邮件</th>
										</tr>
									</thead>
									<tbody>
										<tr>
								...
								<!-- 	<button  onclick="doQuery()" class="btn btn-secondary btn-single">删除</button> -->

	<a href="/RepairManagement/servlet/ToFaultReport?no=${data.customerId} " class="btn btn-secondary btn-single" >报修</a>
	<a href="/RepairManagement/servlet/UpdataServlet?no=${data.customerId} " class="btn btn-secondary btn-single" >编辑</a>
	<a href="/RepairManagement/servlet/CustomerDelete?no=${data.customerId} "  class="btn btn-secondary btn-single">删除</a>
								</div>
